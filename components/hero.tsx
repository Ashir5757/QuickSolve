		...
		<section className="mx-auto w-full max-w-5xl overflow-hidden pt-16">
			...
			<div className="relative z-10 flex max-w-2xl flex-col gap-5 px-4">
				...
				>
					...
					<span className="text-xs font-">Top student tutors available now</span>
				...
				<h1
					className={cn(
						"text-balance font-bold text-4xl text-foreground  md:text-5xl",
				...
				>
					Connect with expert peers for fast, on-demand micro-tutoring. Get unstuck instantly, or start teaching to earn on your schedule.
				</p>
